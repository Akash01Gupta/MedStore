...
// Import Geocoder from "react-map-gl-geocoder"; // Remove if not used
// import userData from './data'; // Remove if not used
import './homemap.css';
...
function Homemap(props) {
	...
	}, [props.value, handleGeocoderViewportChange, props]);
