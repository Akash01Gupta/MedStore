...
export default function Createstore(props) {
    ...
    const getUserLocation = useCallback(async (long, lati) => {
        let list = [];
        let placeName = "";
        if (latitude != null && longitude != null) {
            const res = await axios.get(`https://apis.mappls.com/geocoding/v5/mapbox.places/${long},${lati}.json?access_token=${process.env.REACT_APP_MAPBOX}`);
                    ...
                    <div className="storeregBox">
                        ...
                        <div className="divinput" >
                            <input type="text" required
                                ...
                                onChange={handleChange} />
                            <label htmlFor="">Store Owner Name</label>
                        </div>
