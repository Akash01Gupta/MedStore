...
export default function Tbrow(props) {
    ...
    const handleStatus = async (e) => {
        ...
        try {
             await axios.post(`/api/private/storedashboard/orders`, { orderId: props.value.orderId, storeId: seller.storeId, ownerId: seller._id, status: status }, config).catch(err => {
